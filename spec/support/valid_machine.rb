class ValidMachine
  ...
  state :walking, before_leave: :before_leave_walking, after_leave: :after_leave_walking, before_enter: ->(machine) { machine.before_enter_walking }, after_enter: :after_enter_walking
